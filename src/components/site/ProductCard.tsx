  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-2xl bg-charcoal ring-1 ring-white/5">
        ...
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-noir/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
        ...
        <div className="absolute inset-x-3 bottom-3 translate-y-3 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
          <button className="w-full inline-flex items-center justify-center gap-2 rounded-full bg-ivory text-noir py-2.5 text-[11px] uppercase tracking-luxe font-semibold hover:bg-gold transition-colors">
