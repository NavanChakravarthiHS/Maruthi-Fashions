    ...
    <section className="relative py-24 md:py-32 border-t border-white/5">
      <div className="mx-auto max-w-7xl px-5 lg:px-10">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          <SectionHeading eyebrow="@maruthifashions" title="The Feed" subtitle="Follow the atelier on Instagram." />
          <a href="#" className="inline-flex items-center gap-2 text-[11px] uppercase tracking-luxe text-ivory/70 hover:text-gold transition-colors">
